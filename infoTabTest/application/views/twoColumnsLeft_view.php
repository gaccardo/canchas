...
<div class="row-fluid">
		...
		<div class="span2"><!-- START Porlets of column 1 -->
	...
	<div class="row-fluid">
		<div class="span12">
			<div id="'.$name.'_accordion2_3" class="accordion">
				<div class="accordion-group">
					<div class="accordion-heading">
						<a href="#'.$name.'_widget2_3" data-toggle="collapse" class="accordion-toggle in">
								<span class="divider-vertical"></span><i class="icon-chevron-down icon-white pull-right"></i>
						</a>
					</div>
					<div class="accordion-body collapse in" id="'.$name.'_widget2_3">
						<div class="accordion-inner paddind">
								
								<div class="span12" style="float: left;" id="'.$name.'_barChart2.3">
										<table id="'.$name.'_barChart2_3Table"></table>
								 </div>
						</div><!-- accordion-inner-->
					</div><!-- accordion-body-->
				</div><!--accordion.group-->
